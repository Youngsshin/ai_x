...
class Customer:
    ...
    def to_list_style(self):
        # return '홍길동, 010-9999-9999, a@a.com, 30, 3, 가칠해'
        return '{}, {}, {}, {}, {}, {}'.format(self.name,
                                               ...
                                               self.etc)
    def __str__(self):
        # return '*** 홍길동, 010-9999-9999, a@a.com, 30, 가칠해'
...
def to_customer(row):
    '''
    row = '홍길동, 010-9999-9999, a@a.com, 30, 3, 가칠해'(txt파일 내용)을 매개변수로 받아
    Customer 객체로 return
    '''
    data = row.split(',')
    name = data[0]
...
def load_customers():
    ...
    try:
        with open('data/ch09_customers.txt', 'r', encoding='utf-8') as f:
            ...
            lines = f.readlines()
            for line in lines:
                # line = '홍길동, 010-9999-9999, a@a.com, 30, 3, 가칠해'
